"""
Logging configuration for ElevenLabs Pre-Call Webhook Service.
"""
...
def setup_logger(
    ...
    log_dir = os.getenv("LOG_DIR", "/var/log/elevenlabs-precall-webhook")
    log_filename = os.getenv("LOG_FILENAME", "precall_webhook.log")
    ...
    try:
        ...
        # Custom namer to add timestamp to rotated log files
        ...
        file_handler.addFilter(conversation_filter)
