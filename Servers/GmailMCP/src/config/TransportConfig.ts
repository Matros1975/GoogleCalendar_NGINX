...
Options:
  ...
  --port <number>          Port for HTTP transport (default: 3001)
...
Examples:
  ...
  node build/index.js --transport http --port 3001 # HTTP server
  PORT=3001 TRANSPORT=http node build/index.js     # Using env vars
        `);
        process.exit(0);
    }
  }
